var app = {
    ...
    setMessengerHide: function(){ alert("Hiding in 5 seconds"); app.log("setMessengerHide"); setTimeout(function(){ intercom.hideMessenger(); }, 5000) },
    ...
    bindEvents: function() {
        ...
        $("#setMessengerHide").click(this.setMessengerHide);
